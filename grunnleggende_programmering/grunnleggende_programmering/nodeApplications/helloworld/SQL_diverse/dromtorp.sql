...
--
INSERT INTO
  `datamaskin` (`DatamaskinID`, `Model`, `GBram`)
VALUES
  (1, 'Lenovo E15', '32'),
  (2, 'Mac book Air', '16'),
  (3, 'Lenovo E20', '16');
...
ADD
  PRIMARY KEY (`ElevID`),
ADD
  KEY `datamaskin-con` (`DatamaskinID`),
ADD
  KEY `klasse-con` (`Klasse`);
...
ALTER TABLE
  `datamaskin`
MODIFY
  `DatamaskinID` int(11) NOT NULL AUTO_INCREMENT,
  AUTO_INCREMENT = 4;
...
ALTER TABLE
  `elev`
MODIFY
  `ElevID` int(3) NOT NULL AUTO_INCREMENT,
  AUTO_INCREMENT = 13;
...
ALTER TABLE
  `programfag`
MODIFY
  `ProgramfagID` int(2) NOT NULL AUTO_INCREMENT,
  AUTO_INCREMENT = 5;
...
ALTER TABLE
  `elev`
ADD
  CONSTRAINT `datamaskin-con` FOREIGN KEY (`DatamaskinID`) REFERENCES `datamaskin` (`DatamaskinID`),
ADD
  CONSTRAINT `klasse-con` FOREIGN KEY (`Klasse`) REFERENCES `programfag` (`ProgramfagID`);
